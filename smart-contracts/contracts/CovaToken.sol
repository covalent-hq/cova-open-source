...
contract CovaToken is ERC20 {
  ...
  string private constant name_ = 'Fake Covalent Token';                                 // Set the token name for display
  string private constant symbol_ = 'FCOVA';                                         // Set the token symbol for display
